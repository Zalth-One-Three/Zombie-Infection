...
public class ConfigurationHandler {
	...
	private static void loadConfiguration() {
		...
		slownessTime = configuration.getInt("Timer: Slowness Level 1", CATEGORY_TIMERS, 105, 0, 480, "How many seconds it will take before the player gets the slowness effect (level 1)");
