...
public final class Api {
	/** Returns if a player is has a morph. If morph progress < 1.0F, player is
	 * mid-morphing. Players demorphing are considered as a player with a morph
	 * until the demorph is complete.
	...
	/** Returns morph progression of a player. Time per morph is 80 ticks. If
	 * player does not have a morph, 1.0F will be returned.
	 * @param Player Username
	 * @param Clientside (false for Serverside) */
	...
	/** Returns previous entity instance used to render the morph. If player does
	 * not have a previous morph state, null will be returned.
	 * @param Player Username
	 * @param Clientside (false for Serverside) */
	...
	/** Returns entity instance used to render the morph. If player does not have
	 * a morph, null will be returned.
	 * @param Player Username
	 * @param Clientside (false for Serverside) */
	...
	/** Blacklists an entity from being morphed into. Previously saved morphs of
	 * the classtype will not be removed.
	...
	/** Forces a player to morph into an EntityLivingBase, also adds said entity
	 * to the morph list. Called Serverside only.
	 * @param player
	 * @param living
	...
	/** Forces a player to demorph. Called Serverside only.
	 * @param player */
	...
	/** Checks if the entity passed on is a Morph. If it is, the player name will
	 * be passed, else null.
	...
	/** Allows the rendering of the next player rendered. Prevents Morph from
	 * cancelling the player render event to render the morphed entity. */
	...
	/** Returns the black grainy morph skin that overlays the player when the
	 * player is morphing
	 * @return Morph Skin Resource Location */
	@SideOnly(Side.CLIENT) public static ResourceLocation getMorphSkinTexture() {
		try {
	...
	@SideOnly(Side.CLIENT) public static void registerArmForModel(ModelBase model, ModelRenderer arm) {
		try {
