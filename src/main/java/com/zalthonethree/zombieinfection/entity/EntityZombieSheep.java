...
public class EntityZombieSheep extends EntityMob/*, EntityDragon*/ implements IZombieInfectionMob {
	...
	@Override public void onKillEntity(EntityLivingBase entityLivingIn) {
		...
		if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD && !entityLivingIn.isChild()) && entityLivingIn instanceof EntitySheep) {
